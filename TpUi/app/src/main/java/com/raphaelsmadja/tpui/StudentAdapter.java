...
public class StudentAdapter extends ArrayAdapter<Student> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView lastNameTextView = (TextView) row.findViewById(R.id.lastname);
        TextView firstNameTextView = (TextView) row.findViewById(R.id.firstName);
        Student currentStudent = getItem(position);
        lastNameTextView.setText(currentStudent.getName());
        firstNameTextView.setText(currentStudent.getSurname());
        return row;
    }
}
